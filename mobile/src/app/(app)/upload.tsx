...
const styles = StyleSheet.create({
    ...
    title: { ...typography.h3, color: colors.dark.textPrimary },
    content: { flex: 1, paddingHorizontal: spacing.xl },
    pickerCard: { alignItems: 'center', paddingVertical: spacing.xxl, marginBottom: spacing.lg },
    pickerBtn: { width: '100%' },
    orText: { ...typography.bodySmall, color: colors.dark.textMuted, marginVertical: spacing.md },
    previewCard: { alignItems: 'center' },
    previewImage: { width: '100%', height: 200, borderRadius: borderRadius.md, marginBottom: spacing.md },
    pdfPreview: { width: '100%', height: 120, backgroundColor: colors.dark.surfaceElevated, borderRadius: borderRadius.md, justifyContent: 'center', alignItems: 'center', marginBottom: spacing.md },
    pdfIcon: { fontSize: 48 },
    fileName: { ...typography.bodySmall, color: colors.dark.textSecondary, marginBottom: spacing.lg },
    uploadBtn: { width: '100%' },
});
